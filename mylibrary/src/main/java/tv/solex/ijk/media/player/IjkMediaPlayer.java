...
package tv.solex.ijk.media.player;
...
import tv.solex.ijk.media.player.annotations.AccessedByNative;
import tv.solex.ijk.media.player.annotations.CalledByNative;
import tv.solex.ijk.media.player.misc.IAndroidIO;
import tv.solex.ijk.media.player.misc.IMediaDataSource;
import tv.solex.ijk.media.player.misc.ITrackInfo;
import tv.solex.ijk.media.player.misc.IjkTrackInfo;
import tv.solex.ijk.media.player.pragma.DebugLog;
    ...
    public static void loadLibrariesOnce(IjkLibLoader libLoader) {
        synchronized (IjkMediaPlayer.class) {
            if (!mIsLibLoaded) {
                ...
                libLoader.loadLibrary("ijkffmpegsolex");
                libLoader.loadLibrary("ijksdlsolex");
                libLoader.loadLibrary("ijkplayersolex");
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case REC_VIDEO_STATE:
                    // msg.obj is file name
                    player.notifyOnRecordVideo(msg.arg1, msg.obj == null ? "" : (String) msg.obj);
                    break;
