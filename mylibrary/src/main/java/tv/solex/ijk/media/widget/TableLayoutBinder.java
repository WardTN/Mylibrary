...
public class TableLayoutBinder {
    ...
    public TableLayoutBinder(Context context) {
        this(context, R.layout.table_endo_media_info);
    }
    ...
    public View appendRow1(String name, String value) {
        return appendRow(R.layout.table_endo_media_info_row1, name, value);
    }
    ...
    public View appendRow2(String name, String value) {
        return appendRow(R.layout.table_endo_media_info_row2, name, value);
    }
    ...
    public View appendSection(String name) {
        return appendRow(R.layout.table_endo_media_info_section, name, null);
    }
